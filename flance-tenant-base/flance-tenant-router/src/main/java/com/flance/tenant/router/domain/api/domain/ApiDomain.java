package com.flance.tenant.router.domain.api.domain;
...
public class ApiDomain {
    ...
    public void deleteById() {
        ...
        waitDelete.setId(apiEntity.getId());
    ...
    public List<ApiEntity> list() {
        List<ApiEntity> list = apiService.list(buildDefault(apiEntity));
        list.forEach(apiService::setRouteModel);
        return list;
    }
    ...
    public PageResponse<ApiEntity> page(PageRequest<ApiEntity> pageRequest) {
        ...
        page.getRecords().forEach(apiService::setRouteModel);
